...
export default function howWeCalculate() {
  ...
  return (
    <Layout isText={true} maxContainerWidth="100%">
      <Flex direction={["column", "row"]} px={["10px", "50px"]} py="48px" gap="50px">
        <Flex width={["100%", "70%"]} direction="column">
          <Text fontWeight={600} fontSize="34px" pb={[0,"30px"]} textShadow="0px 4px 4px rgba(0, 0, 0, 0.25)">Carbon Emission Calculation and Reporting</Text>
        ...
        <Flex width={["100%", "30%"]} direction="column" shadow="0px 0px 7.2px rgba(35, 47, 78, 0.25)" borderRadius="15px">
          <Flex background="#E5F4E3">
            <Text fontWeight={700} fontSize="24px" lineHeight="29px" p="34px">Table of Contents</Text>
          </Flex>
          <Flex>
            <UnorderedList p="24px 34px">
              <ListItem fontWeight={700} fontSize="16px" lineHeight="24px" color="#044B7F" pb="12px">
              ...
              <ListItem fontWeight={700} fontSize="16px" lineHeight="24px" color="#044B7F">
