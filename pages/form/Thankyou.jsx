...
export default function Thankyou() {
  return (
    <Layout isText background="#044B7F">
      <Flex alignItems="center" flexDir="column" w="90%">
        <TYCloud />
        <Heading color="#fff" mt={5} mb={5}>
          Thank you for participating!
        </Heading>
        <Text color="#fff" mt={5} fontSize="18px" textAlign={["center", "start"]}>
          We’re collecting responses from 1 - 19 November, and the results will be shared by your work representative at the end of the survey.
        </Text>
        <Text color="#fff" mt={5} fontSize="18px" textAlign={["center", "start"]}>
