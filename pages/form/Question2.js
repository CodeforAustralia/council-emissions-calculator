...
import { Box, Grid, Heading, Text, Select } from "@chakra-ui/react";
...
export default function Question2() {
  ...
  const [selectedMode, setSelectedMode] = useState(
    answers.mainModeOfTransport || ""
  );

  const saveAnswers = () =>
    setAnswers((prev) => ({ ...prev, mainModeOfTransport: selectedMode }));
        ...
        <>
          <Box mt={6}>
            ...
            <Text my={5}>
              ...
              the train for 15km, choose train as your way of travel.
            </Text>
            <Text my={5}>
              If you currently work from home, we will use this information to
