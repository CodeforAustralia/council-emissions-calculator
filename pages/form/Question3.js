...
export default function Question3() {
  ...
  const saveAnswers = () => setAnswers((prev) => ({ ...prev, km }));
  ...
  return (
    <Layout>
      ...
      <Text mt="4">
        You can use{" "}
        <Link href="https://maps.google.com.au" color="blue" isExternal={true}>
          Google Maps
        </Link>{" "}
        to measure the distance from your home to usual workplace.
      </Text>
      <Text mt="4">
        If you currently work from home, let us know how far it is from your
