  ...
  return (
    ...
    >
      ...
      <Flex direction="column">
        ...
        <Text fontSize="19px">Travel methods have been grouped into <b>Active-Public-Shared</b> methods and <b>Individual</b> methods: </Text>
      </Flex>
      <Flex direction="column" gap="10px">
        <Flex gap="30px" direction={["column", "row"]} justify={["center", "space-between"]} align="center">
          <Flex direction="column">
            <Text fontWeight={600} color="#022640" fontSize="22px">Active/Public/Shared Methods:</Text>
            <Text color="#03385F">Lower carbon emission per kilometre travel per person</Text>
          </Flex>
          <Flex gap="30px">
            <Flex direction="column" width="100px" align="center">
              <Flex justify="center" align="center" width="95px" height="95px" background="#E6EEF3" boxShadow="0px 1px 30px rgba(230, 238, 243, 0.99)" borderRadius="50%">
                <WalkingMan />
              </Flex>
              <Text textAlign="center" width="80px" color="#044B7F">Walk/Run/Cycle</Text>
            </Flex>
            <Flex direction="column" width="100px" align="center">
              <Flex justify="center" align="center" width="95px" height="95px" background="#E6EEF3" boxShadow="0px 1px 30px rgba(230, 238, 243, 0.99)" borderRadius="50%">
                <Train />
        ...
        <Flex gap="30px" direction={["column", "row"]} justify={["center", "space-between"]} align="center">
          <Flex direction="column">
            <Text fontWeight={600} color="#022640" fontSize="22px">Individual Methods:</Text>
            <Text color="#03385F">Higher carbon emission per kilometre travel per person.</Text>
          </Flex>
          <Flex gap="30px">
            <Flex direction="column" width="100px" align="center">
              <Flex justify="center" align="center" width="95px" height="95px" background="rgba(214, 158, 46, 0.36)" boxShadow="0px 1px 30px rgba(214, 158, 46, 0.25)" borderRadius="50%">
                <Car />
              </Flex>
