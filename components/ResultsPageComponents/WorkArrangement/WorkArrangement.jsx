  ...
  return (
    <RightPaddedContent flex={[1, 2]}>
      ...
      <Text fontSize="19px" py="15px">
        The infographics below illustrate responders’ working arrangement across
        the week. This information helps identify the percentage of staff
        commuting to work in regular (on-site) and intermittent (hybrid)
        patterns.
      </Text>
